...
@Composable
internal fun TvShowsFeedScreen(
        ...
        LazyColumn(
            ...
            item {
                ContentSection(
                    ...
                    sectionName = stringResource(Res.string.airing_today),
            ...
            item {
                ContentSection(
                    ...
                    sectionName = stringResource(Res.string.on_air),
                    appendItems = appendItems,
                    onItemClick = onItemClick,
                    onSeeAllClick = onSeeAllClick
                )
    ...
    LazyRowContentSection(
        ...
        sectionHeaderContent = {
            ContentSectionHeader(
                ...
                onSeeAllClick = { onSeeAllClick(FeedType.TV, content.category.name) },
