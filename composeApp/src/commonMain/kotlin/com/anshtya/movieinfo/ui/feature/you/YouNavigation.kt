...
import com.anshtya.movieinfo.ui.feature.you.library_items.LibraryItemsRoute
...
const val libraryTypeNavigationArgument = "type"
...
fun NavGraphBuilder.youScreen(
    ...
    navigation(
        ...
        composable(
            route = "$libraryItemsNavigationRoute/{$libraryTypeNavigationArgument}",
            arguments = listOf(
                navArgument(libraryTypeNavigationArgument) { type = NavType.StringType }
            )
        ) {
            LibraryItemsRoute(
