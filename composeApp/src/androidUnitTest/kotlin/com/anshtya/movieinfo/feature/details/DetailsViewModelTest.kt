...
import com.anshtya.movieinfo.common.data.repository.test.TestDetailsRepository
...
import com.anshtya.movieinfo.ui.feature.details.DetailsViewModel
import com.anshtya.movieinfo.ui.feature.details.idNavigationArgument
...
class DetailsViewModelTest {
    ...
    fun `test tv show details content state`() = runTest {
        ...
        assertEquals(
            ContentDetailUiState.TvSeries(data = testTvSeriesDetails),
            viewModel.contentDetailsUiState.value
        )
